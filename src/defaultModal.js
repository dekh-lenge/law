...
import close from './assets/emoji/cool.svg';
...
const Dialog = props => {
    ...
    const CloseButton = props.showCloseButton ? <span className="modal-close" onClick={props.onClose}><img src={close}/></span> : null;
